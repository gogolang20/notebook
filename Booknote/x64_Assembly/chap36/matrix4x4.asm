...
main:
    ...
    ;p1*s2+s3;xmm14=xmm14*xmm9+xmm10
    vfmadd231sd   xmm14,xmm13,xmm8
    ;xmm14+p2*s1;xmm14=xmm14+xmm13*xmm8
    ...
    ;p1*s3+s4;xmm15=xmm15*xmm10+xmm11
    vfmadd231sd   xmm15,xmm13,xmm9
    ;xmm15+p2*s2;xmm15=xmm15+xmm13*xmm9
    vfmadd231sd   xmm15,xmm14,xmm8
    ;xmm15+p3*s1;xmm15=xmm15+xmm14*xmm8
